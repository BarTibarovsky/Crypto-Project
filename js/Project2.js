$(document).ready(function () {
    ...
    const render1 = () => {
        ...
        $('#2').css('opacity', '1')
        $('#3').css('opacity', '1')
        $('#first-content').html('<h1>All Crypto Coins<h1>');
        $('#mid-content').empty();
    ...
    const render2 = () => {
        ...
        if (coinsList[0] == undefined || coinsList[1] == undefined || coinsList[2] == undefined || coinsList[3] == undefined || coinsList[4] == undefined) {
            $('#mid-content').empty()
            $('#mid-content').css('height', '100%');
            $('#mid-content').html(`<h2 id="errMsg">Please choose five coins!</h2>`)
        }
        else {
    ...
    const render3 = () => {
        ...
        $('#first-content').html("<h1>Hi I'm Bar!<h1>");
        return `
                        <div id="project-description">
                        <h2>An uprising star in the Javascript Full Stack Developing arena <br><h2>
                        <br>
                        <div class="p">
                        What made me choose a Developing career? <br> 
                        It's a method I inherited from my parent ;) <br>
                        My father was a Developer, and with great excitment I follow his lead.<br>
                        Other than being utterly fascinated by JS, I enjoy music, some gaming and own an honorable Red Aikido belt.<br>
                        Checkout my Git!  https://github.com/BarTibarovsky<br>
                        </div>
                        </div>
                        
                        <div class="about-card">
                        <img src="./Photos/BarTibarovsky.jpeg" style="width:80%; height: 80%;" onclick= "goToMyGit()" ><br>
                        <div class="about-container">
                        <h4><b>Bar Tibarovsky</b></h4> 
        ...
        $.get('https://api.coingecko.com/api/v3/coins/list', function coinslist(data) {
            ...
            for (let i = 0; i < data.length; i++) {
                ...
                $(`#btn${i}`).click(() => {
                    ...
                    // Remove form localStorage After 2 minutes 
                    setInterval(() => {
                ...
                $(`#switch-btn${i}`).click(event => {
                    ...
                    //on/off mode check
                        ...
                        //Remove from array when off mode
                        else {
                            parseInt(id)
    ...
    // show button when scrolled 20px
